 ...
 * @author adson
 */
public class Mesa_Telas_Inicio extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mesa_Telas_Inicio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Mesa_Telas_Inicio().setVisible(true);
            }
        });
    }
     ...
     * @return the cardapio
     */
    public static Mesa_Telas_Cardapio getCardapio() {
        return cardapio;
    }
