...
public class Caixa {
    ...
    private Caixa_Interface cliente;
    ...
    public String Conectar(){
        try {
            ...
            RegistryImpl registryImpl = new RegistryImpl(12347);

            // Instanciando a classe ServidorImpl que é do tipo ServidorInterface.
            cliente = new CaixaImpl();

            Naming.rebind("rmi://127.0.0.1:12347/Mesa", cliente);
            ...
            servidor.imprimirMensagem("1#12347");
